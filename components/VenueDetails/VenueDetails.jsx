...
//         <img className="back__link-image" src="/src/assets/images/Arrow.svg" alt="back arrow pointing left"></img>
//         <h3>Home</h3>
//       </Link>
...
const VenueDetails = ({ id }) => {
  ...
  return (
    <div className="venue-details">
      <Link to="/" className="back__link">
        <img className="back__link-image" src="/src/assets/images/Arrow.svg" alt="back arrow pointing left" />
        <h3>Home</h3>
      </Link>
      ...
      <h2>{venue.name}</h2>
      <button className={`favourite__button-card ${isFavourite ? "liked" : ""}`} onClick={toggleFavourite}>
        {isFavourite ? "❤️" : "♡"}
      </button>
      ...
      <div className="filter__container">
        <h3>Please select a day and time to see deals:</h3>
        <DayFilter availableDays={availableDays} selectedDay={selectedDay} onDayClick={setSelectedDay} />
