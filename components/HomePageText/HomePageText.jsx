      ...
      <div className="homepage__text">
        ...
        <section className="homepage__text-container">
          ...
          <p>
            ...
            looking for an afternoon pint, evening cocktails, or late-night
            bites, we've got you covered! 🍻🍹
          </p>
        </section>
        ...
        >
          <source
            src="src/assets/images/Homepage-video-PD.mp4"
            type="video/mp4"
          />
        </video>
        <section className="homepage__text-container">
          ...
          <p>
            ...
            you're a cocktail connoisseur, beer enthusiast, or foodie looking
            for the best bites, we make happy hour hunting effortless.
          </p>
          <p>
